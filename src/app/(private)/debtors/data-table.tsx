...
import { NotifyOverdueModal } from "@/components/modal/notify-overdue-modal";
...
export function DataTable<TData, TValue>({
  ...
  data = [],
  selectedYear,
  setSelectedYear = () => {}, // Fallback para função vazia
  selectedMonth,
  setSelectedMonth = () => {}, // Fallback para função vazia
